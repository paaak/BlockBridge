...
#[derive(Debug)]
pub struct BlockBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockBridge processing");
    
    let mut processor = BlockBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockBridgeProcessor::new(false);
